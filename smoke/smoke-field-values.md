...
`SmokeTests.swift` の `docIDs` が正本。以下はそのミラー。

| ファイル | 企業 | 会計基準 |
|---|---|---|
| `4901_2025-03-31.json` | 富士フイルム | US-GAAP |
| `7751_2025-12-31.json` | キヤノン | US-GAAP |
| `8306_2025-03-31.json` | 三菱UFJ | J-GAAP（金融） |
| `8316_2025-03-31.json` | 三井住友 | J-GAAP（金融） |
| `6103_2025-03-31.json` | オークマ | J-GAAP（事業会社） |
| `6326_2025-12-31.json` | クボタ | IFRS |
| `2802_2025-03-31.json` | 味の素 | IFRS |
| `2871_2025-03-31.json` | ニチレイ | J-GAAP |
| `7269_2025-03-31.json` | スズキ | IFRS |
| `7422_2025-12-20.json` | 東邦レマック | J-GAAP（非連結） |
