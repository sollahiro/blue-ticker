...
// 個別ハードコードしている（Extraction / EmployeesRD / CapexOverview / GoodwillSmoke+Golden /
// Resolver / LiveLLM。一覧は本ファイルの @Test 関数名、または
// `swift test --filter RealXbrlBreakdown --list-tests`）。
//
