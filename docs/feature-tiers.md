...
| Norm | Breakdown | 事業別・地域別の売上／従業員／研究開発 | 売上 business/geography 公開済。employees/rd は軸あり・**公開予定**。goodwill は Stage1 | `breakdown.md` |
...
| Feed | Update | 新規取得・公開された有報などの更新情報 | 未 | |
...
| `rd` | 研究開発費内訳 | 公開予定（日経225・軸あり） |
| `goodwill` | のれん | Stage1（ingest/REST 未配線） |
