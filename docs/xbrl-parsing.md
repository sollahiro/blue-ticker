...
| Overview ライブ生成 | `SwiftTests/BlueTickerTests/Spec/Oracle/RealXbrlOverviewLiveTests.swift` | スパイク7社（7203/8306/6758/2802/7751/4901/6098）。実 XBRL「事業の内容」→ 50〜80字・数字混入なし。文面は非決定なのでオラクル凍結しない。`OPENROUTER_OVERVIEW_API_KEY` と `tmp_cache/edinet` が無いとき SKIP |
