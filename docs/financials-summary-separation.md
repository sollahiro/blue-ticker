...
| `fin-vN` | 存続。IBD の notes リース欠測埋めは `fin-v6`。途中の IA 切替ではバンプしない。組立完成（Extractor 残件の切替後）が次世代 |
...
| # | 内容 |
|---|---|
| 8 | IBD 定義は PR #247。利息 4/9、cf_treasury_stock 8/10、buyback 8/10。`USGAAPHtml` 残件もここ |
