...
| 5 | **本表水準値の statement 参照** | sales / OP / BS 合計 / ppe_total / AR·Inv·AP / 現金 / dividend_paid_cf を statement 行から組立 | 完了（本 PR）。J-GAAP/IFRS は Statement 採用タグの許可リスト＋元 fact FieldSet。US-GAAP は HTML Statement ラベル＋AR/AP 内訳合算。gross_profit / sga / CFO·CFI は未移行 |
