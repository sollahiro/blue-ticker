...
└─ L1 売上総利益
   ...
   │  └─ L3 その他販管費
   ├─ L2 その他営業損益（residual。味の素の GP − 販管費 − OP）
...
| 味の素（IFRS） | 113,968m | 550,764 − 366,854 ＝ 183,910m | その他営業損益 |
...
`売上総利益 → 事業利益 → 営業利益` を独立した3段にはしない。

Waterfall の式 `事業利益 = 売上総利益 − 販管費` は、販管費を開示販管費に固定すれば常に成り立つ。その販管費から R&D を分解できるのは、R&D がその数の内数のときだけ。別掲 R&D はその販管費に入っていない。

キヤノン: 開示販管費 `1,367,277m`、別掲 R&D `339,288m`。`1,367,277 − 339,288` を「その他販管費」にすると、開示に無い残差を発明する。R&D をその子にできない。

| 開示 | GP − 開示販管費＝事業利益 | その販管費から R&D を分解 | 事業利益 → OP |
|---|---|---|---|
| 内数（オークマ） | 成り立つ。事業利益 ≡ OP | できる（内数） | 0。段が潰れる |
| 内数＋その他営業（味の素） | 成り立つ | できる（内数） | その他営業 69,942m |
| 別掲（キヤノン） | 成り立つ（794,678m） | できない。R&D は内数ではない | R&D 339,288m がこちらに残る |

別掲でも R&D を販管費の子にする（親＝開示販管費＋R&D）と、キヤノンは GP − 親 ＝ OP になり、間の事業利益は営業利益と同一。Waterfall の販管費から分解することと、R&D を常に販管費の子にすることは両立しない。

味の素のその他営業は、売上総利益の直下で販管費・営業利益と並べる residual。事業利益ノードは足さない。
