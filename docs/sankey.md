...
開示行は探さない。`business_profit = 売上総利益 − 販管費`（販管費が無ければ `GP − OP` で販管費を埋めてから引く）。売上総利益と営業総利益が両方あり、販管費が営業総利益から落ちるとき（イオン）は営業総利益を GP にする。その場合 事業利益＝営業利益。味の素の `BusinessProfitLossIFRS`（159,302m）はこれではない。

| 例 | 営業利益 | Waterfall 事業利益 | R&D の置き場 |
|---|---|---|---|
| イオン S100Y5VH | 270,459m | ＝営業利益（営業総利益 3,910,376 − 販管費 3,639,916） | 販管費は葉 |
