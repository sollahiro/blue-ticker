...
public let companyFinancialsCacheVersion = "fin-v21"
...
// | gross_profit, sga | statement（income_statement 行）。GP は売上総利益（売上高−売上原価）。営業総利益（営業収益合計−営業原価合計）が併記され販管費がその直上なら営業総利益。無ければ営業収益−営業費用+販管費、その次に銀行業務粗利益 | StatementFinancialsResolver（#5c） | done |
