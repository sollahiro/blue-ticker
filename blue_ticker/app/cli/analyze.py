    ...
    if getattr(args, "half", False):
        try:
            ...
            half_metrics_to_show = [
                ...
                ("投下資本 (百万)",    lambda d: d.get("InvestedCapital")),
                ("有利子負債合計 (百万)", lambda d: d.get("InterestBearingDebt")),
                ("総資産 (百万)",      lambda d: d.get("TotalAssets")),
                ("流動資産 (百万)",    lambda d: d.get("CurrentAssets")),
                ("固定資産 (百万)",    lambda d: d.get("NonCurrentAssets")),
                ("流動負債 (百万)",    lambda d: d.get("CurrentLiabilities")),
                ("固定負債 (百万)",    lambda d: d.get("NonCurrentLiabilities")),
