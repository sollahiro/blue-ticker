...
async def cmd_analyze(args):
    ...
    if getattr(args, "half", False):
        try:
            ...
            half_metrics_to_show = [
                ...
                ("コア営業利益 (百万)", lambda d: d.get("AdjustedOperatingProfit")),
                ("コア営業利益率 (%)", lambda d: d.get("AdjustedOperatingMargin")),
                ("NOPAT (百万)",       lambda d: d.get("NOPAT")),
                ("純利益 (百万)",      lambda d: d.get("NP")),
                ("コア営業利益前年差", lambda d: d.get("OperatingProfitChange")),
    ...
    try:
        ...
        metrics_to_show = [
            ...
            ("コア営業利益 (百万)",     calculated_metric(lambda c: c.get("AdjustedOperatingProfit"))),
            ("コア営業利益率 (%)",      calculated_metric(lambda c: c.get("AdjustedOperatingMargin"))),
            ...
            ("コア営業利益前年差",      calculated_metric(lambda c: c.get("OperatingProfitChange"))),
